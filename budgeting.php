...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="alert alert-secondary">
            <p class="mb-0">Rencanakan pengeluaran bulanan Anda dengan menetapkan anggaran untuk setiap kategori. Ini akan membantu Anda mengontrol pengeluaran dan memastikan keuangan Anda tetap sehat.</p>
        </div>
