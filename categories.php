...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="alert alert-secondary">
            <p class="mb-0">Kategori membantu Anda mengelompokkan transaksi. Dengan kategori yang baik, Anda bisa mendapatkan laporan keuangan yang lebih detail dan mudah dipahami.</p>
        </div>
                ...
                <form method="POST" action="categories.php">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="icon-picker" class="d-flex flex-wrap gap-2 border p-2 rounded" style="max-height: 200px; overflow-y: auto;">
                            ...
                            if (!in_array($current_icon, $icons) && $form_mode == 'edit') {
